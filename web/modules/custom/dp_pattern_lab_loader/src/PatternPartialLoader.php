...
// This class is borrowed directly from Pattern Lab Twig Engine:
use Twig\Source;
use Twig\Loader\LoaderInterface;

class PatternPartialLoader implements LoaderInterface {
  ...
  public function getSourceContext($name) {
    return new Source($this->getSource($name), $name, $this->findTemplate($name));
  }
